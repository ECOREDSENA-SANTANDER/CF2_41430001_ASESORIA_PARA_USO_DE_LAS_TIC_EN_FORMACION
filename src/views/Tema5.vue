  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
          ...
          .col-md-6.col-xl.mb-4.mb-xl-0
            .tarjeta-numerada.color-primario.p-4.h-100.mb-0
              .tarjeta-numerada__numero
                .h2 1
              p.text-center.mx-3 Citar correctamente las fuentes (autor, año, origen).
          .col-md-6.col-xl.mb-4.mb-xl-0
            .tarjeta-numerada.color-secundario.p-4.h-100.mb-0
              .tarjeta-numerada__numero
                .h2 2
              p.text-center.mx-3 Utilizar imágenes, textos y videos con licencias adecuadas.
          .col-md-6.col-xl.mb-4.mb-xl-0
            .tarjeta-numerada.color-acento-contenido.p-4.h-100.mb-0
              .tarjeta-numerada__numero
                .h2 3
              p.text-center.mx-3 Evitar la reproducción de contenidos sin autorización.
    ...
    .row.justify-content-center.align-items-stretch.mb-4.mb-lg-5(data-aos="fade-left")
      .col-lg-4.col-md-6.mb-lg-0.mb-4
        .bg311.p-4.h-100.cen
          p.mb-0.text-center Buscar en repositorios confiables.
      .col-lg-4.col-md-6.mb-lg-0.mb-4
        .bg311.p-4.h-100.cen
          p.mb-0.text-center Verificar licencias (como Creative Commons).
      .col-lg-4.col-md-6.mb-lg-0.mb-4
        .bg311.p-4.h-100.cen
      ...
      .row.justify-content-center.align-items-center.mb-0
        .col-lg-6.mb-lg-0.mb-4
          ul.lista-ul.mb-0
            li.d-flex.mb-3
              i.fas.fa-globe
              p.mb-0 Uso de contraseñas seguras y verificación en dos pasos.
            li.d-flex.mb-3
              i.fas.fa-globe
              p.mb-0 Identificación de riesgos como el #[em phishing] o enlaces sospechosos.
            li.d-flex.mb-3
              i.fas.fa-globe
              p.mb-0 Actualización de dispositivos y configuración de privacidad.
            li.d-flex.mb-0
              i.fas.fa-globe
